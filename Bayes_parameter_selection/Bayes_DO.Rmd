...
turnover = as.Date("2013-10-01")
#turnover = as.Date("2014-10-15")
#turnover = as.Date("2015-09-28")
#turnover = as.Date("2016-10-07")
#turnover = as.Date("2017-07-12")
#turnover = as.Date("2018-10-22")
#turnover = as.Date("2019-10-30")
year <- year(turnover) #I am doing this one year at a time right now
...
#for Schmidt (driver variable?)
#Schmidt <- as.matrix(read_csv("./Buoy_year_by_week_Schmidt_11AUG19.csv"))
...
write.jagsfile(jags.out, file=file.path("./",paste(year,paste0(model_name,'.txt'), sep = '_')), 
...
sink(file = file.path("./",paste(year,paste0(model_name,'_param_summary.txt'), sep = '_')))
