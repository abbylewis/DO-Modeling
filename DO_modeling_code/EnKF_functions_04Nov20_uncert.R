...
get_obs_error_matrix = function(n_states, n_params_obs, n_step, state_cv, param_sd, obs){
  
  R = array(0, dim = c(n_states + n_params_obs, n_states + n_params_obs, n_step))
  
  state_var = (obs*state_cv)^2 #variance of oxygen observations, designed to be flexible over time
  state_var = state_var[1,1,]
