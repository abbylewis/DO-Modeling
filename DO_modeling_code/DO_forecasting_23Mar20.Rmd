...
To do:
- Is there an oxygenation blip in 2018 that I don't have? What about 2016? 
  -- I do think there is something I could fix for 2018
  -- I don't think there is anything in 2016. The model captured it okay with the flexible hypo depth so maybe it was just thermocline movement
- Add something about the amount of time since an observation (not just forecast date)
- Try increasing theta
- See what the ko2 value is from GLM-AED. Maybe lower since the only temp forecast is better in 2014?
...
model_name = "SSS" #Options for model_name: SSS, temp, o2, full. SSS is no temp no o2, O2 is no temp. Temp is no o2.
gif = T
