...
To do:
- Standardize graphs by the amount of error
...
- Observation uncertainty is not a thing. Models need to be different already to get adjusted by enkf
- Made graphs of partitioned uncertainty as a function of forecast horizon and day of summer for each year
