...
To do:
For every year:
  - Run the model with specified driver uncertainty but no variability in initial conditions, params, or observations. Calculate SD of ensembles at each time step: this is driver uncertainty
  - Repeat for parameter uncertainty, initial conditions, and observations
  - I'm not sure how to do process uncertainty?
  - Calculate overall variance between ensembles with all uncertainties included to see how much of this is explained by drivers/params/obs/initial conditions
...
gif = F
uncert = "obs" #Options = "all", "obs","init","driver","param"
...
write.csv(results_2013,paste("../DO_modeling_results/31Mar20/forecast_2013_",model_name,"_model_",uncert,"_uncert.csv", sep = ""))
...
write.csv(results_2014,paste("../DO_modeling_results/31Mar20/forecast_2014_",model_name,"_model_",uncert,"_uncert.csv", sep = ""))
...
write.csv(results_2015,paste("../DO_modeling_results/31Mar20/forecast_2015_",model_name,"_model_",uncert,"_uncert.csv", sep = ""))
...
write.csv(results_2016,paste("../DO_modeling_results/31Mar20/forecast_2016_",model_name,"_model_",uncert,"_uncert.csv", sep = ""))
...
write.csv(results_2017,paste("../DO_modeling_results/31Mar20/forecast_2017_",model_name,"_model_",uncert,"_uncert.csv", sep = ""))
...
write.csv(results_2018,paste("../DO_modeling_results/31Mar20/forecast_2018_",model_name,"_model_",uncert,"_uncert.csv", sep = ""))
...
write.csv(results_2019,paste("../DO_modeling_results/31Mar20/forecast_2019_",model_name,"_model_",uncert,"_uncert.csv", sep = ""))
...
model_name = "full" #Options for model_name: SSS, temp, o2, full. SSS is no temp no o2, O2 is no temp. Temp is no o2.
gif = F
uncert = "init" #Options = "all", "obs","init","driver","param"
...
model_name = "full" #Options for model_name: SSS, temp, o2, full. SSS is no temp no o2, O2 is no temp. Temp is no o2.
gif = F
uncert = "driver" #Options = "all", "obs","init","driver","param"
...
model_name = "full" #Options for model_name: SSS, temp, o2, full. SSS is no temp no o2, O2 is no temp. Temp is no o2.
gif = F
uncert = "param" #Options = "all", "obs","init","driver","param"
...
SDs <- read.csv(paste("../DO_modeling_results/31Mar20/forecast_",year,"_full.csv",sep = ""))
SDs = SDs[FALSE,seq(31,44)] 

#Run through all saved forecasts
for(year in seq(2013,2019)){
  full <- read.csv(paste("../DO_modeling_results/31Mar20/forecast_",year,"_full.csv",sep = ""))
  full_sd <- full%>%
    select(seq(31,44))%>%
    summarize_all(~mean(.,na.rm = T))%>%
    mutate(uncert = "full",
           year = year)
  obs <- read.csv(paste("../DO_modeling_results/31Mar20/forecast_",year,"_full_model_obs_uncert.csv",sep = ""))
  obs_sd <- obs%>%
    select(seq(31,44))%>%
    summarize_all(~mean(.,na.rm = T))%>%
    mutate(uncert = "obs",
  ...
  param_sd <- param%>%
    ...
    mutate(uncert = "param",
           year = year)
  driver <- read.csv(paste("../DO_modeling_results/31Mar20/forecast_",year,"_full_model_driver_uncert.csv",sep = ""))
  driver_sd <- driver%>%
    select(seq(31,44))%>%
    summarize_all(~mean(.,na.rm = T))%>%
