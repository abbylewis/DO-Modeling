...
test_2018 <- run_do_hindcast(inputs_2018,obs,stop)
plot_o2(test_2018,stop,start,stop)

#2019
start = as.Date("2019-06-03")
stop = as.Date("2019-10-30")
inputs_2019 <- inputs_year(start,stop,CTD,SSS)
test_2019 <- run_do_hindcast(inputs_2019,obs,stop)
plot_o2(test_2019,stop,start,stop)
```
