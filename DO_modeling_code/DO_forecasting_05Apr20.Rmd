...
## Parameters
parms <- c(
  R20 = .7, #mg/L/day #0.0093 from Carey (but I don't have DOC)
  theta = 1.12, #1.08 from Hipsey
  ko2 = .5, #mg/L #Could use .2 from Carey L&O paper
  sss_scalar = 3 #.46 from Carey but no idea what their units are
)
...
test_2013 <- run_do_hindcast(inputs_2013,obs,stop, n_days = 40)
...
full <- read.csv("../DO_modeling_results/rmse_full_06May20.csv")
...
crps_all <- all_model[c(2,seq(45,ncol(all)))]
crps_final = crps_all%>%
