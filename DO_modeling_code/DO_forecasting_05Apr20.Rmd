...
test_2013 <- run_do_hindcast(inputs_2013,obs, stop, parms = parms)
...
test_2014 <- run_do_hindcast(inputs_2014,obs,stop, parms = parms)
...
test_2015 <- run_do_hindcast(inputs_2015,obs,stop, parms = parms)
...
test_2016 <- run_do_hindcast(inputs_2016,obs,stop, parms = parms)
...
test_2017 <- run_do_hindcast(inputs_2017,obs,stop, parms = parms)
