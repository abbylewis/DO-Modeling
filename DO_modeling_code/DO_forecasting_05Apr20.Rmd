...
To do:
- Present parameters in shiny app
- Linear regression of temperatures for each training year, use average
...
```{r}
temp <- read.csv("../DO_modeling_results/rmse_temp_15Apr20.csv")
o2 <- read.csv("../DO_modeling_results/rmse_o2_15Apr20.csv")
full <- read.csv("../DO_modeling_results/rmse_full_15Apr20.csv")
sss <- read.csv("../DO_modeling_results/rmse_sss_15Apr20.csv")
persist <- read.csv("../DO_modeling_results/rmse_persist_15Apr20.csv")
