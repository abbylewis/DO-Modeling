...
- Run forecasts in Bayes model (training data) to get parameter values
...
param_cv = c(R20 = .1,
             ...
             ko2 = .1,
             sss_scalar = .1)
driver_cv = c(SSS = .1,# This is the main source of uncertainty right now
              temp = .1,
...
#for(uncert in c("param","all")){ 
  ...
  gif = F
  uncert = "driver" #Options = "all","init","driver","param","proc"
